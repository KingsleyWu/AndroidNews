...
/**
 * class name : GankIoAllDate
 * created date : on 2018/1/17 13:37
 *
 * @author Kingsley
 * @version 1.0
 */

public class GankIoAllDate implements Serializable{
    ...
    public static class Results implements Serializable, MultiItemEntity {
        /**
         ...
         * 普通布局，带略缩图
         */
        public static final int GANK_IO_ITEM_CUSTOM = 1;
        /**
         * 图片布局，福利
         */
        public static final int GANK_IO_ITEM_WELFARE = 2;
        /**
         * 无图布局
         */
        public static final int GANK_IO_ITEM_CUSTOM_NO_IMAGE = 3;
