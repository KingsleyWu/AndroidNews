...
import com.kingsley.androidnews.callback.OnArticleFragmentRefreshListener;
 ...
 */
public abstract class BaseArticlesFragment<V extends BaseContract.View, P extends BasePresenterImpl> extends BaseMVPFragment<V, P> implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (root.findViewById(R.id.swipe_refresh_layout) == null) {
            throw new IllegalStateException("you layout must include the fragment_list.xml");
        }
        initView(root);
        return root;
    }
    ...
    public OnArticleItemClickListener getOnArticleItemClickListener() {
        return new OnArticleItemClickListener() {
            @Override
            public void OnArticleItemClick(ArticleData.Data.Article article) {
